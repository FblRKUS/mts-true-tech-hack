      ...
      Dropdown($$renderer3, {
        ...
        $$slots: {
          ...
          content: ($$renderer4) => {
            ...
            if (help) {
              $$renderer4.push("<!--[0-->");
              $$renderer4.push(`<hr class="border-gray-50/30 dark:border-gray-800/30 my-1 p-0"/> <button class="flex rounded-xl py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition cursor-pointer select-none" type="button" id="chat-share-button"><div class="self-center mr-3">`);
