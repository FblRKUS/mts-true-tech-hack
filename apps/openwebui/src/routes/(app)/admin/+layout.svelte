			...
			<div class=" flex items-center gap-1">
				...
				<div class=" flex w-full">
					...
					>
						...
						<a
							draggable="false"
							class="min-w-fit p-1.5 {$page.url.pathname.includes('/admin/settings') && !$page.url.pathname.includes('/admin/settings/gpthub')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition select-none"
						...
						<a
							draggable="false"
							class="min-w-fit p-1.5 {$page.url.pathname.includes('/admin/settings/gpthub')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition select-none"
							href="/admin/settings/gpthub">GPTHub {$i18n.t('Settings')}</a
						>
					</div>
				</div>
			</div>
